...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "undoNote";
    private static String CALENDARS_ACCOUNT_NAME = "undoNote@undoNote.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.undoNote";
    private static String CALENDARS_DISPLAY_NAME = "undoNote";
